...
- [#134](https://github.com/o3co/auth.proxy/issues/134): the two modes log differently — the request-id field name, the type of `error`, and the level of a caller-caused provider 401 — so one log query does not cover both.
