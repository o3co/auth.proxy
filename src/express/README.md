...
Not tested: the mount order (F17). That the forwarded `Authorization` equals the inbound bytes (F14) is pinned on the validation path since #101 and documented on the injection one.
