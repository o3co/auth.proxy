...
| Applied by | validation mode (the handler in [`validation/router.mts`](../modes/validation/router.mts)) | the exchange ([`createExchangeHandler`](../modes/injection/exchange.mts)) |
