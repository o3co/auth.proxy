...
export const introspect = async (
  ...
  const { data } = await axios.post<IntrospectionResult>(
    ...
    { headers: { 'Content-Type': 'application/x-www-form-urlencoded', 'Authorization': authHeader, 'x-request-id': requestId }, timeout: timeoutMs },
  );

  // Sweep expired entries before size check
